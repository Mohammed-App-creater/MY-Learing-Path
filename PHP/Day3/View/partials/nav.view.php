            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/"
                           class=" <?= $heading === 'Home' ? "bg-gray-900 text-white" : "text-gray-300 hover:bg-gray-700 hover:text-white" ?> rounded-md  px-3 py-2 text-sm font-medium"
                           aria-current="page">Home</a>
                        <a href="about"
                           class="<?= $heading === 'About Us' ? "bg-gray-900 text-white" : "text-gray-300 hover:bg-gray-700 hover:text-white" ?> rounded-md px-3 py-2 text-sm font-medium  ">About
                            Us</a>
                        <a href="/notes"
                           class="<?= $heading === 'Notes' ? "bg-gray-900 text-white" : "text-gray-300 hover:bg-gray-700 hover:text-white" ?> rounded-md px-3 py-2 text-sm font-medium  ">Notes</a>
                        <a href="/contact"
                           class="<?= $heading === 'Contact Us' ? "bg-gray-900 text-white" : "text-gray-300 hover:bg-gray-700 hover:text-white" ?>  rounded-md px-3 py-2 text-sm font-medium ">Contact
                            Us</a>
                    </div>
                </div>
            </div>
